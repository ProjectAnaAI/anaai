    ...
    const result =
      await openai.responses.create({
        ...
        instructions: [
          ...
          "When stage is 'confirm', supplying a replacement service, date, or time is a correction even if the caller also uses booking language.",
          "For example, at confirmation, 'book for me for three thirty in the afternoon' means correction=true, time_expression='three thirty in the afternoon', and confirmation=null.",
          "Replacement appointment details at confirmation must be revalidated and freshly confirmed before booking.",
