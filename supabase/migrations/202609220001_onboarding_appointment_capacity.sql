-- Require the owner-selected simultaneous capacity during business onboarding.
-- CREATE OR REPLACE preserves the existing function identity and execution ACL.
-- All existing provisioning behavior is retained; validation precedes every write.
